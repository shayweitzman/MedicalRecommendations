...
//				currentRelativePath.toAbsolutePath().toString() + "//source//images//third.png");
//		JLabel lblNewLabel = new JLabel(Welcome.resizeIcon(image, 100, 100));
...
//
//		ImageIcon passwordImage = new ImageIcon(
//				currentRelativePath.toAbsolutePath().toString() + "//source//images//password.png");
...
//
//		ImageIcon cPasswordImage = new ImageIcon(
//				currentRelativePath.toAbsolutePath().toString() + "//source//images//confirmpassword.png");
//		JLabel lblCPassLabel = new JLabel(Welcome.resizeIcon(cPasswordImage, 55, 55));
...
//				(ActionListener) new SignUp(SignUpframe, txtUserName, txtPassword, txtId, txtCPassword));
